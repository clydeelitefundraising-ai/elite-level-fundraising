    ...
    <div style={{ animation: "elf-fadeUp .22s ease both" }}>
      ...
      {canUpload && !uploading && (
        <div
          ...
          onDrop={handleDrop}
          style={{
            border: `2px dashed ${dragOver ? "var(--team-primary)" : "#d1d5db"}`,
            borderRadius: 12,
            padding: "1.5rem 1rem",
            textAlign: "center",
            cursor: "pointer",
        ...
        <Modal title="Rename File" onClose={closeEdit}>
          <div style={{ display: "flex", flexDirection: "column", gap: ".875rem" }}>
            ...
            <div style={{ display: "flex", gap: ".5rem", justifyContent: "flex-end", paddingTop: ".25rem" }}>
              ...
              <button onClick={handleRename} disabled={editSaving} style={{ padding: ".5rem 1rem", background: "var(--team-primary)", color: "#fff", border: "none", borderRadius: 9, fontSize: ".85rem", fontWeight: 600, cursor: editSaving ? "not-allowed" : "pointer", opacity: editSaving ? .7 : 1 }}>
