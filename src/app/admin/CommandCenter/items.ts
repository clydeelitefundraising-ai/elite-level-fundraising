...
export const PAGE_ITEMS: CmdItem[] = [
  ...
  { id: "page-reports",      kind: "page",   label: "Reports",             icon: "📊", href: "/admin/reports",     group: "PAGES" },
  ...
  { id: "page-notifications", kind: "page",  label: "Notifications",       icon: "🔔", href: "/admin/notifications", group: "PAGES" },
...
export const ACTION_ITEM_DEFS: Omit<CmdItem, "action">[] = [
  ...
  { id: "action-reports",       kind: "action", label: "Open Reports",            icon: "📊", href: "/admin/reports",            group: "ACTIONS" },
  ...
  { id: "action-notifications", kind: "action", label: "Open Notifications",       icon: "🔔", href: "/admin/notifications",         group: "ACTIONS" },
