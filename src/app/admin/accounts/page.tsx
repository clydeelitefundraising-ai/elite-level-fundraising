...
export default async function AccountsPage() {
  ...
  type RawCoach    = { id: string; campaign_slug: string; name: string; email: string | null; role: string; account_id: string | null; created_at: string };
  type RawMember   = { id: string; campaign_slug: string; name: string; email: string | null; phone: string | null; role: string; athlete_id: string | null; account_id: string | null; created_at: string };
  ...
  const campaignSlugs = campaigns.map(c => c.campaign_slug);
  ...
  const accounts: AccountRow[] = [...coachRows, ...memberRows];

  return <AccountsView accounts={accounts} campaignSlugs={campaignSlugs} campaignLabel={campaignLabel} />;
}
