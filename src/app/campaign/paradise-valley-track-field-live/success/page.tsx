    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <div style={styles.card}>
          ...
          <p style={styles.sub}>
            Your donation to the <strong>Paradise Valley Pumas Track &amp; Field</strong> program
            has been received. Every dollar you contribute helps our student athletes compete
            and grow this season.
          </p>
          <div style={styles.divider} />
          <p style={styles.note}>
            A receipt has been sent to your email by Stripe. If you have any questions,
            contact us at <a href="mailto:support@elitelevelfundraising.com" style={styles.link}>
              support@elitelevelfundraising.com
            </a>.
          </p>
          <a href="/campaign/paradise-valley-track-field-live" style={styles.btn}>
            ← Back to Campaign
          </a>
        </div>
...
async function saveDonation(sessionId: string) {
  try {
    const secretKey = process.env.STRIPE_SECRET_KEY;
    if (!secretKey) { console.error("[success] STRIPE_SECRET_KEY not set"); return; }

    console.log("[success] fetching Stripe session", sessionId);
